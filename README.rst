...
- **ML Studies**:
   - RFM Analysis on Online Retail Customer Dataset and Business Insights
   - Penguin Species Classification using Logistic Regression, Naive Bayes and a Neural Network.
